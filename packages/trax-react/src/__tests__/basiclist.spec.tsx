...
describe('Simple List', () => {
    ...
    describe('Single Instance', () => {
        ...
        it('should load the list and add / clear items', async () => {
            expect(listHost(0).dataset.id).toBe("React/%FC:Test:BasicList:1");
    ...
    describe('Multi Instances', () => {
        ...
        it('should work independently', async () => {
            ...
            expect(listItemLength(0)).toBe(0);
            expect(listTotalText(0)).toBe("Total: 0");
            expect(listHost(1).dataset.id).toBe("React/%FC:Test:BasicList:2");
    ...
    describe('Dispose', () => {
        it('should be called when the component is removed from the DOM', async () => {
            ...
            expect(listItemLength(0)).toBe(0);
            expect(listTotalText(0)).toBe("Total: 0");
            const cptProcessor = trax.getProcessor("React/%FC:Test:BasicList:1")!;
            ...
            expect(listItemLength(0)).toBe(0);
            expect(listTotalText(0)).toBe("Total: 0");
            const cptProcessor2 = trax.getProcessor("React/%FC:Test:BasicList:2")!;
