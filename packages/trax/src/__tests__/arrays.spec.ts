    ...
    describe('Computed', () => {
        ...
        it('should compute array from another one (non empty start)', async () => {
            ...
            expect(printLogs(3)).toMatchObject([
                ...
                "3:24 !GET - FStore/Info:data*members*1.desc -> 'Marge Simpson'",
                "3:25 !GET - FStore/Info:data*members*0.desc -> 'Homer Simpson'",
                "3:26 !GET - FStore/Info:data*members*2.desc -> 'Bart Simpson'",
                "3:27 !GET - FStore/Info:data*members*1.desc -> 'Marge Simpson'",
                "3:28 !GET - FStore/Info:data*members*2.desc -> 'Bart Simpson'",
                "3:29 !GET - FStore/Info:data*members*1.desc -> 'Marge Simpson'",
                "3:30 !GET - FStore/Info:data*members*2.desc -> 'Bart Simpson'",
                "3:31 !GET - FStore/Info:data*members*1.desc -> 'Marge Simpson'",
                "3:32 !GET - FStore/Info:data*members*2.desc -> 'Bart Simpson'",
                "3:33 !GET - FStore/Info:data*members*1.desc -> 'Marge Simpson'",
                "3:34 !GET - FStore/Info:data*members*2.desc -> 'Bart Simpson'",
                "3:35 !GET - FStore/Info:data*members*0.desc -> 'Homer Simpson'",
                "3:36 !GET - FStore/Info:data*members*2.desc -> 'Bart Simpson'",
                "3:37 !GET - FStore/Info:data*members*0.desc -> 'Homer Simpson'",
                "3:38 !PCS - !ArrayUpdate (FStore/data*infos) - parentId=3:8",
                "3:39 !GET - FStore/data*infos.length -> 3", // No changes
                "3:40 !PCE - 3:38",
                "3:41 !PCE - 3:8",
                "3:42 !PCE - 3:7",
            ]);
        ...
        describe('Errors', () => {
            it('should be raised in case of invalid updateArray arguments', async () => {
                ...
                expect(printLogs(0)).toMatchObject([
                    ...
                    "0:7 !NEW - A: FStore/data*infos",
                    "0:8 !SET - FStore/data.infos = '[TRAX FStore/data*infos]' (prev: undefined)",
                    "0:9 !NEW - A: FStore/data*members",
                    "0:10 !GET - FStore/data.members -> '[TRAX FStore/data*members]'",
                    "0:11 !GET - FStore/data*members.map -> '[Function]'",
                    "0:12 !GET - FStore/data*members.length -> 0",
            ...
            it('should be raised when a computed array is updated by multiple processors (direct change)', async () => {
                ...
                expect(printLogs(1)).toMatchObject([
                    ...
                    "1:4 !GET - FStore/data*members.length -> 1",
                    "1:5 !GET - FStore/data*members.0 -> '[TRAX FStore/data*members*0]'",
                    "1:6 !GET - FStore/data*members*0.firstName -> 'Bart'",
                    "1:7 !ERR - [TRAX] Computed content conflict: FStore/data*infos.0 can only be set by FStore%Infos",
                    "1:8 !PCE - 1:3",
                ]);
            });
            ...
            it('should be raised when a computed array is updated by multiple processors (updateArray change)', async () => {
                ...
                expect(printLogs(1)).toMatchObject([
                    ...
                    "1:5 !GET - FStore/data*members.0 -> '[TRAX FStore/data*members*0]'",
                    "1:6 !GET - FStore/data*members*0.firstName -> 'Bart'",
                    "1:7 !ERR - [TRAX] Computed content conflict: FStore/data*infos can only be changed by FStore%Infos",
                    "1:8 !PCS - !ArrayUpdate (FStore/data*infos) - parentId=1:3",
                    "1:9 !GET - FStore/data*infos.length -> 1",
                    "1:10 !ERR - [TRAX] Computed content conflict: FStore/data*infos.0 can only be set by FStore%Infos",
                    "1:11 !PCE - 1:8",
                    "1:12 !PCE - 1:3",
                ]);
                ...
                expect(printLogs(3)).toMatchObject([
                    "3:1 !LOG - B",
                    "3:2 !GET - FStore/data*members.0 -> '[TRAX FStore/data*members*0]'",
                    "3:3 !SET - FStore/data*members*0.firstName = 'Maggie' (prev: 'Bart')",
                    "3:4 !DRT - FStore%Info2 <- FStore/data*members*0.firstName",
                    "3:5 !PCS - !Reconciliation #1 - 1 processor",
                    "3:6 !PCS - !Compute #2 (FStore%Info2) P2 Reconciliation - parentId=3:5",
                    "3:7 !GET - FStore/data*members.length -> 1",
                    "3:8 !GET - FStore/data*members.0 -> '[TRAX FStore/data*members*0]'",
                    "3:9 !GET - FStore/data*members*0.firstName -> 'Maggie'",
                    "3:10 !PCS - !ArrayUpdate (FStore/data*infos) - parentId=3:6",
                    "3:11 !GET - FStore/data*infos.length -> 1",
                    "3:12 !NEW - O: FStore/data*infos*0",
                    "3:13 !SET - FStore/data*infos.0 = '[TRAX FStore/data*infos*0]' (prev: '[TRAX FStore/Info:data*members*0]')",
                    "3:14 !PCE - 3:10",
                    "3:15 !PCE - 3:6",
                    "3:16 !PCE - 3:5",
                ]);
